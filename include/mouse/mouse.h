...
namespace rwa2 {
    ...
    class Mouse {
         ...
         */
        bool search_maze(int& nx, int& ny, int gx, int gy, rwa2::Mouse& M, std::stack<std::vector<int>>& s, std::vector<std::vector<int>>& v);
        /**
         * @brief Make the mouse move forward
         *
         */
        void move_forward(rwa2::Mouse M);
        /**
         * @brief Make the mouse rotate 90 deg CCW
         *
         */
        void turn_left(rwa2::Mouse M);
        /**
         * @brief Make the mouse rotate 90 deg CW
         *
         */
        void turn_right(rwa2::Mouse M);

        bool find_in_vector(std::vector<std::vector<int>> v, std::vector<int> n);
